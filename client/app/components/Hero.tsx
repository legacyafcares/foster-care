...
const Hero = () => {
  ...
  return (
    <div className='relative w-full h-full'>
      ...
      <div className='absolute lg:top-[200px] lg:ml-[600px] top-[120px] grid place-items-end p-4 w-fit text-white'>
        ...
        <Button onClick={handleClick} className='mx-auto mt-3' colorScheme='green'>Learn More</Button>
      </div>
    </div>
  )
}
