  ...
  return (
    <>
      <p
        ...
        className="cursor-pointer lg:text-lg md:text-md hover:text-green-400 transition ease-in-out duration-700 hover:scale-95"
      >
        Contact Us
      </p>
      <Modal isOpen={isOpen} onClose={onClose} size={"lg"} isCentered>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader className="font-afacad text-green-700 ml-6 text-md">
            Here's how you can get in touch with us:
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <div className="grid gap-3 h-[200px] w-[300px] justify-items-start lg:text-xl text-md mb-12 ml-6">
